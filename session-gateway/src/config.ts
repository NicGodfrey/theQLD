...
export const config = {
  ...
  workerModelId: process.env.WORKER_MODEL_ID || "gpt-5.6-sol",
  workerReasoning: process.env.WORKER_REASONING || "xhigh",
  workerContext: process.env.WORKER_CONTEXT || "272k",
  workerFast: process.env.WORKER_FAST || "false",
