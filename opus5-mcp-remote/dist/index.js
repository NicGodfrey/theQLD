...
const STATE_FILE = process.env.OPUS5_REMOTE_STATE_FILE ??
...
const server = new Server({ name: "opus5-mcp-remote", version: "1.0.0" }, { capabilities: { tools: {} } });
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: "ask_opus5",
            description: "通过远程中转站调用 Claude Opus 5。Cursor API Key 在中转服务器，本机只需 RELAY 令牌。",
            inputSchema: {
                type: "object",
                properties: {
